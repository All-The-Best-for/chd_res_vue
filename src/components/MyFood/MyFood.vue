      ...
      <div class="food" v-if="isShowFoodDetail">
          <div class="food-content">
              <div class="image-header">
                  <img v-lazy="food.dishIcon?ImageBasePathHeader+food.dishPicture1:''">
                  <p class="foodpanel-desc">{{food.info}}</p>
              </div>
              <div class="content">
                  <h1 class="title">{{food.dishName}}</h1>
                  <div class="detail">
                      <span class="sell-count">月售{{food.dishSales}}份</span>
                      <span class="rating">好评率{{(food.dishStar*20).toFixed(2)}}%</span>
                  </div>
                  <div class="price">
